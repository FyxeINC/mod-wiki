/* Site and project metadata for the static GitHub Pages wiki. */
window.WIKI_DATA = {
  "site": {
  ...
  "projects": [
    ...
    },
    {
      ...
      "type": "mod",
      "name": "FFFoodSpoilageAndPreservation",
      "index": "F",
      "status": "active",
    ...
    },
    {
      ...
      "index": "L",
      "status": "planning",
      "description": "A planned mod project; its current source still uses the example mod identity.",
      "tagline": "A planned mod project; its current source still uses the example mod identity.",
      "version": "0.0.3",
      "minecraftVersion": "1.21.1",
      "modrinthSlug": "",
      "icon": "",
    ...
    {
      "slug": "ffmodsubfolders",
      "type": "mod",
      "name": "FFModsSubfolders",
      "index": "M",
      "status": "active",
    ...
    },
    {
      ...
      "index": "P",
      "status": "active",
      "description": "Makes placed torches burn out, react to rain, and be relit.",
      "tagline": "Makes placed torches burn out, react to rain, and be relit.",
      "version": "0.0.3",
      "minecraftVersion": "1.21.1",
      "modrinthSlug": "",
      "icon": "",
